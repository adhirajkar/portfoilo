...
import { RiNextjsFill, RiReactjsFill, RiTwitterXLine } from "react-icons/ri"
import { SiExpress, SiApple, SiAndroid } from "react-icons/si"
      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Adhiraj Kar</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <a href="mailto:adhirajkar3103@gmail.com">adhirajkar3103@gmail.com</a>
            </div>
            <div className="flex items-center gap-1">
          ...
          A full-stack and mobile developer passionate about crafting seamless user experiences across web and mobile platforms, while building scalable and efficient backend systems. Eager to leverage my comprehensive technical skills to deliver robust, high-performance end-to-end solutions.
          </p>

          <div className="flex flex-wrap gap-2 sm:gap-3">
            <Link
              href="/AdhirajResume.pdf"
              target="_blank"
              download
            >
            ...
            <Link
              href="https://github.com/adhirajkar"
              target="_blank"
            >
            ...
            <Link
              href="mailto:adhirajkar3103@gmail.com"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
        ...
        >
          <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md aspect-square">
            ...
            <div className="absolute inset-0 grid grid-cols-2 gap-2 sm:gap-4 p-2 sm:p-4">
              ...
              {/* Bottom Right - React Native with iOS/Android icons */}
              <motion.div
                className="bg-muted rounded-lg p-2 sm:p-4 flex flex-col items-center justify-center"
                animate={{
                  boxShadow: [
              ...
              >
                <div className="text-4xl text-[#087ea4] mb-1">
                  <RiReactjsFill />
                </div>
                <div className="flex gap-1">
                  <SiApple className="text-sm text-gray-600" />
                  <SiAndroid className="text-sm text-green-600" />
                </div>
              </motion.div>
            </div>
